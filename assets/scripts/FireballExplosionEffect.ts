 ...
 */
@ccclass('FireballExplosionEffect')
export class FireballExplosionEffect extends Component {
    ...
    private drawCircle(progress: number) {
        ...
        // 绘制填充圆形
        this.graphics.fillColor = new Color(255, 100, 0, alpha); // 橙红色
        this.graphics.circle(0, 0, currentRadius);
        this.graphics.fill();

        // 绘制边框
        this.graphics.strokeColor = new Color(255, 200, 0, alpha); // 金黄色边框
