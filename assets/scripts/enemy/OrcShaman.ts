import { _decorator, Prefab, Node, Vec3, find, instantiate, SpriteFrame, Color, Label, UIOpacity, tween, LabelOutline } from 'cc';
            ...
            (damage: number, hitDirection: Vec3) => {
                ...
                if (targetNode && targetNode.isValid && targetNode.active) {
                    ...
                    const targetScript = towerScript || warAncientTreeScript || hallScript || swordsmanHallScript || crystalScript ||
                                        ...
                                        mercenarySoldierScript || eagleArcherScript ||
